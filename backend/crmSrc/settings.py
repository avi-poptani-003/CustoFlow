...
SECRET_KEY = 'django-insecure-n#g_n7#mgg08v)cnvh&)bo4t&2(cwmkemrrfrs_=xt_qn+oh+r'
...
WSGI_APPLICATION = 'crmSrc.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'your db password',  # Change to your database password
        'HOST': 'localhost',
        'PORT': '5432'
    }
}
...
EMAIL_HOST_USER = 'your email here' # Your email account
EMAIL_HOST_PASSWORD = 'password here' # Your email password
DEFAULT_FROM_EMAIL = 'from address' # Default 'from' address for automated emails
